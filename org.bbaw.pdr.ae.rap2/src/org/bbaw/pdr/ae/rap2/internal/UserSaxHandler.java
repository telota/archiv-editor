...
public class UserSaxHandler extends DefaultHandler
{
	...
	@Override
	public final void endElement(final String uri, String localName, final String qName) throws SAXException
	{
		localName = qName;
	...
	@Override
	public final void startElement(final String uri, String localName, final String qName, final Attributes atts)
			throws SAXException
	{
		localName = qName;
		if (localName.equals("user") || localName.equals("uodl:user"))
