...
public abstract class AbstractBox implements Box {
     ...
     * endOffset, inclusive.
     * @see net.sf.vex.layout.Box#containsOffset(int)
     */
     ...
     * @see net.sf.vex.layout.Box#getHeight()
     */
     ...
     * @see net.sf.vex.layout.Box#getWidth()
     */    
    public int getWidth() {
        return this.width;
    }
     ...
     * @see net.sf.vex.layout.Box#getX()
     */
    public int getX() {
        return this.x;
    }
     ...
     * @see net.sf.vex.layout.Box#getY()
     */
    public int getY() {
        return this.y;
    }
