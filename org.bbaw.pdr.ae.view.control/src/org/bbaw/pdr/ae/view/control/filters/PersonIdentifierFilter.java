...
/**
 * The Class PersonIdentifierFilter.
 * @author Christoph Plutte
 */
public class PersonIdentifierFilter extends ViewerFilter
{
	...
	private boolean hasChildConcurrence(final TreeNode tn)
	{
		if (tn.getPdrObject() != null && (tn.getPdrObject() instanceof Person))
		{
			...
			if (p.getIdentifiers() != null && !p.getIdentifiers().getIdentifiers().isEmpty())
			{
				return true;
			}
			else
