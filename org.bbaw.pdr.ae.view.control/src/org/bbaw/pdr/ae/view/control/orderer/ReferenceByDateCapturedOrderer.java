...
/**
 * The Class ReferenceByDateCapturedOrderer.
 * @author Christoph Plutte
 */
public class ReferenceByDateCapturedOrderer implements ReferencesOrderer
{
	...
	/**
	 * Instantiates a new reference by date captured orderer.
	 */
	public ReferenceByDateCapturedOrderer()
	{
	}
	...
	public final Vector<OrderingHead> orderedReferences(final Vector<ReferenceMods> references, IProgressMonitor monitor)
	{
		...
		{
			if (reference.getOriginInfo() != null && reference.getOriginInfo().getDateCaptured() != null)
			{
				date = "" + reference.getOriginInfo().getDateCaptured().getYear();
