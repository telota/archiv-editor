...
/**
 * The Class ReferenceByCopyRightDateOrderer.
 * @author Christoph Plutte
 */
public class ReferenceByCopyRightDateOrderer implements ReferencesOrderer
{
	...
	/**
	 * Instantiates a new reference by copy right date orderer.
	 */
	public ReferenceByCopyRightDateOrderer()
	{
	}
	...
	public final Vector<OrderingHead> orderedReferences(final Vector<ReferenceMods> references, IProgressMonitor monitor)
	{
		...
		{
			if (reference.getOriginInfo() != null && reference.getOriginInfo().getCopyrightDate() != null)
			{
				date = "" + reference.getOriginInfo().getCopyrightDate().getYear();
