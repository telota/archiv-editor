...
public class Activator extends AbstractUIPlugin
{
	...
	protected final void initializeImageRegistry(final ImageRegistry reg)
	{
		...
		reg.put(IconsInternal.CLIPBOARD, ImageDescriptor.createFromFile(IconsInternal.class, IconsInternal.CLIPBOARD));
		reg.put(IconsInternal.CLIPBOARD_PLUS , ImageDescriptor.createFromFile(IconsInternal.class, IconsInternal.CLIPBOARD_PLUS));
        reg.put(IconsInternal.CLIPBOARD_MINUS, ImageDescriptor.createFromFile(IconsInternal.class, IconsInternal.CLIPBOARD_MINUS));

		reg.put(IconsInternal.CLIPBOARD_SAVE, ImageDescriptor.createFromFile(IconsInternal.class, IconsInternal.CLIPBOARD_SAVE));
