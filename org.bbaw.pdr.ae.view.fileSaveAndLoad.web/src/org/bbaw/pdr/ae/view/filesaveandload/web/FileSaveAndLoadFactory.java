...
public class FileSaveAndLoadFactory implements IFileSaveAndLoadFactory {

	@Override
	public IFileSaveHandling createFileSaveHandling() {
		return new FileSaveHandlingWeb();
	}

	@Override
	public IFileLoadHandling createFileLoadHandling() {
		return new FileLoadHandlingWeb();
	}
