...
public class CallPersonAspectEditorHandler implements IHandler
{
	/** The _facade. */
	...
	public Object execute(ExecutionEvent event) throws ExecutionException
	{
		if (_facade.getCurrentPerson() != null)
		{
			...
			if (a != null && p.getAspectIds().contains(a.getPdrId()))
			{
				PersonAspectEditor dialog = new PersonAspectEditor(PlatformUI.getWorkbench().getActiveWorkbenchWindow()
						.getShell(), p, a);
				dialog.open();
			}
			else
