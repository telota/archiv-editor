...
/**
 * The Class IDSaxHandler.
 * @author Christoph Plutte
 */
public class IDSaxHandler implements ContentHandler
{

	/** The ids. */
	private Vector<String> _ids = new Vector<String>();
			...
			throws SAXException
	{
		if (localName.equals("id"))
		{
			for (int i = 0; i < atts.getLength(); i++)
			{
				...
				{
					_id = new String(atts.getValue(i));
				}
			}
		}
