...
/**
 * The Class FilterOnlyAspectsDivergentMarkupHandler.
 * @author Christoph Plutte
 */
public class FilterOnlyAspectsDivergentMarkupHandler implements IHandler, IElementUpdater
{
	...
	public final Object execute(final ExecutionEvent event) throws ExecutionException
	{
		...
		Command command = cService.getCommand("org.bbaw.pdr.ae.view.main.commands.FilterOnlyAspectsDivergentMarkup");
		State tState = command.getState(AEPluginIDs.TOGGLE_STATE_FILTERONLYASPECTSDIVERGENTMARKUP);
		_isChecked = (Boolean) tState.getValue();
		if (!_isChecked)
		{
			currentTree.addFilter(new OnlyAspectDivergentMarkup());
		}
		else
		{
			...
			else
			{
				...
				{
					if (f instanceof OnlyAspectDivergentMarkup)
					{
	...
	@Override
	public final void updateElement(final UIElement element, @SuppressWarnings("rawtypes") final Map arg1)
	{
