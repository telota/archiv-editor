...
/**
 * The Class FilterOnlyIncorrectObjectsHandler.
 * @author Christoph Plutte
 */
public class FilterOnlyIncorrectObjectsHandler implements IHandler, IElementUpdater
{
	...
	public final Object execute(final ExecutionEvent event) throws ExecutionException
	{
		...
		Command command = cService.getCommand("org.bbaw.pdr.ae.view.main.commands.FilterOnlyIncorrectObjects");
		State tState = command.getState(AEPluginIDs.TOGGLE_STATE_FILTERONLYINCORRECTOBJECTS);
		_isChecked = (Boolean) tState.getValue();
		if (!_isChecked)
		{
			currentTree.addFilter(new OnlyIncorrectPDRObjectsFilter());
		}
		else
		{
			...
			else
			{
				...
				{
					if (f instanceof OnlyIncorrectPDRObjectsFilter)
					{
