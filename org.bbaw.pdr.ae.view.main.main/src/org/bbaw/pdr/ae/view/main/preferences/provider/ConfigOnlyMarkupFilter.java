...
/**
 * The Class ConfigOnlyMarkupFilter.
 * @author Christoph Plutte
 */
public class ConfigOnlyMarkupFilter extends ViewerFilter
{
	...
	public final boolean select(final Viewer viewer, final Object parentElement, final Object element)
	{
		...
		{
			return !(cd.getValue().contains("relation") || cd.getValue().contains("semantic"));
		}
		else
		{
			return true;
