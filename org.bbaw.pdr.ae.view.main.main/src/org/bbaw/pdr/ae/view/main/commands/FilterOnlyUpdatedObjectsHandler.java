...
/**
 * The Class FilterOnlyUpdatedObjectsHandler.
 * @author Christoph Plutte
 */
public class FilterOnlyUpdatedObjectsHandler implements IHandler, IElementUpdater
{
	...
	public final Object execute(final ExecutionEvent event) throws ExecutionException
	{
		...
		Command command = cService.getCommand("org.bbaw.pdr.ae.view.main.commands.FilterOnlyUpdatedObjects");
		State tState = command.getState(AEPluginIDs.TOGGLE_STATE_FILTERONLYUPDATEDOBJECTS);
		_isChecked = (Boolean) tState.getValue();
		if (!_isChecked)
		{
			currentTree.addFilter(new TreeNodeUpdatedFilter());
		}
		else
		{
			...
			else
			{
				...
				{
					if (f instanceof TreeNodeUpdatedFilter)
					{
