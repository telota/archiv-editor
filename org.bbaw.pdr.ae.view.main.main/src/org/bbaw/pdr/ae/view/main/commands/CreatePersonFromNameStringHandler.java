...
public class CreatePersonFromNameStringHandler implements IHandler
{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException
	{
		...
		PdrId id = new PdrId(aspectId);
		Aspect originalAspect = null;
		if (id != null)
		{
			originalAspect = _facade.getAspect(id);
		}
		...
		// e.printStackTrace();
		// }
		AspectEditorDialog editor = new AspectEditorDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow()
				.getShell(), p, a, "Create a new person from selected text.");
